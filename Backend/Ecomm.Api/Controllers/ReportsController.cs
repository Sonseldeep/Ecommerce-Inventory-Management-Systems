...
public class ReportsController : ControllerBase
{
    ...
    {
        return Download(_reports.ExportInventoryPackAsync(req, ct));
    }
    ...
    {
        return Download(_reports.ExportCategoryInventorySheetsAsync(req, ct));
    }
