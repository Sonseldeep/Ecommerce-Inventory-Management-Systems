...
//           <Link to={isAuthenticated ? "/dashboard" : "/login"} className="font-extrabold text-xl">Ecomm</Link>
...
//                   Cart
//                   {count > 0 && <span className="absolute -top-2 -right-3 bg-red-500 text-white text-xs rounded-full px-1.5">{count}</span>}
//                 </Link>
...
//               <button onClick={onLogout} className="bg-black text-white px-3 py-1.5 rounded">Logout</button>
//             </div>
//           )}
//         </div>
//       </header>
